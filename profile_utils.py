...
def save_profile(profile: Dict[str, Any], profile_path: str = "profile.json") -> None:
...
def mark_seen(movie_id: str, profile: Dict[str, Any], profile_path: str = "profile.json") -> None:
...
def rate_movie(movie_id: str, rating: float, profile: Dict[str, Any], profile_path: str = "profile.json") -> None:
    """Attribue une note personnelle à un film."""
    profile.setdefault("personal_ratings", {})[movie_id] = rating
    save_profile(profile, profile_path)

def update_last_suggested(movie_id: str, profile: Dict[str, Any], profile_path: str = "profile.json") -> None:
